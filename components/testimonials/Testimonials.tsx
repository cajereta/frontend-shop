  ...
  return (
    <div className="flex gap-6 my-10 px-12 md:px-14 xl:px-24 flex-col h-[40rem] md:flex-row w-full justify-center  ">
      ...
      <div className="relative w-full md:w-[70%] h-full rounded-md">
        ...
        />
        <div className="absolute top-0 flex w-full h-full bg-black/60 rounded-xl justify-center items-center [text-shadow:_0px_10px_10px_rgb(0_0_0_/_60%)]">
          <div className="flex w-3/5 h-3/5 rounded-lg bg-white/30 items-center">
            <div className="flex flex-col text-center gap-2 mx-auto items-center">
              ...
              <p className="text-gray-100 font-medium">Starting from $19.99</p>
            </div>
          </div>
        </div>
      </div>
